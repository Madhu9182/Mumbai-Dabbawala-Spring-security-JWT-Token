...
public class UserController {
    ...
    public String saveRegistration(@RequestBody UserRegistration userRegistration) {
        return userService.saveRegistration(userRegistration);
    }

    @PutMapping("/update")
    public String updateRegistration(@RequestBody UserRegistration userRegistration) throws UserNameNotFoundException {
    ...
    public UserRegistration getRegistration(@PathVariable("username") String username) throws UserNameNotFoundException {
    ...
    public String deleteRegistration(@PathVariable("username") String username) throws UserNameNotFoundException {
